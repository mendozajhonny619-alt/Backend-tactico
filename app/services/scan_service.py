    ...
    def escanear_partidos(self, live_matches, odds_data):
        ...
        for match in live_matches:
            try:
                ...
                riesgo = RiskEngine.evaluar_riesgo(match, match.get("market", "OVER_MATCH_DYNAMIC"))
                ...
                if mercado.get("valid"):
                    ...
                    valor = {"status": "LOW_VALUE", "edge": 0, "value_category": "SIN_VALOR"}
                ...
                if (
                    ...
                    match.update({
                        ...
                        "recomendacion_final": "PREMIUM" if valor.get("edge", 0) > 0.15 else "ESTÁNDAR"
                    })
